class Pyramid {
    ...
    public Pyramid(
        String pharaoh, String ancient_name, String modern_name, Integer dynasty,
        String site, Double base1, Double base2, Double height, Double slope,
        Double volume, Double latitude, Double longitude, String type,
